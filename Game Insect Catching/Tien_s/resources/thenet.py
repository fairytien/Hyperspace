...
pyglet.resource.path = ['/tmp/guest-cp2xg8/Downloads']
...
score_label = pyglet.text.Label(text="Score: ", font_size=30, bold=True, x=15, y=720)
level_label = pyglet.text.Label(text="Time: ",
                                font_size=30, bold=True, x=1200, y=720, anchor_x='center',)
...
def create_bees(num_bees):
    ...
    for i in range(num_bees):
        ...
        bee_image = pyglet.image.load_animation('bee.gif')
